...
<body>
<div id="main">
<form method="post" action="assignreviewers.php" name="userform" id="userform" onsubmit="return checkForm(this); return false;">
  <fieldset>
<?php
  ...
  if(!empty($_SESSION['LoggedIn']) && !empty($_SESSION['Username']))
{
  ...
  if(!empty($_POST["Update"])){
    $getProposals = $db->prepare("SELECT * FROM proposal WHERE (
    SELECT COUNT(*)
    FROM review 
    WHERE proposal.FileID = review.FileProposalID) < 3");
